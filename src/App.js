...
export default function App() {
  return (
    <BrowserRouter>
      <AuthProvider>
        fallback={<div style={{ display:'flex', alignItems:'center', justifyContent:'center', height:'100vh', fontFamily:'DM Sans,sans-serif', color:'#A8917A', fontSize:14 }}>Loading...</div>}
        <Routes>
