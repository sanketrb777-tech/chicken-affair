                          ...
                          <td style={{ padding: '12px 16px' }}>
                            <div style={{ display: 'flex', gap: 8 }}>
                              ...
                              <button
                                ...
                                style={{ display: 'flex', alignItems: 'center', gap: 5, background: '#fff5f5', border: 'none', borderRadius: 7, padding: '6px 12px', fontSize: 12, fontWeight: 600, color: '#15803D', cursor: 'pointer', opacity: printingId === bill.id ? 0.6 : 1 }}>
