...
const ROLE_CONFIG = {
  owner:   { label: 'Owner',   bg: '#fee2e2', color: '#b91c1c', border: '#f87171' },
  manager: { label: 'Manager', bg: '#fee2e2', color: '#b91c1c', border: '#fca5a5' },
  captain: { label: 'Captain', bg: '#fee2e2', color: '#15803D', border: '#fecaca' },
            ...
            <div key={s.id} style={{ background: '#fff', borderRadius: 12, border: '1px solid ' + theme.border, padding: '16px 20px', display: 'flex', alignItems: 'center', gap: 16, boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
              ...
              <div style={{ display: 'flex', gap: 8, flexShrink: 0 }}>
                ...
                <button onClick={() => toggleActive(s)}
                  style={{ background: '#fee2e2', border: '1px solid #f87171', borderRadius: 7, padding: '6px 14px', fontSize: 12, fontWeight: 600, cursor: 'pointer', color: '#b91c1c' }}>
                  Deactivate
                </button>
            ...
            {inactiveStaff.map(s => {
              ...
              return (
                <div key={s.id} style={{ background: '#fff', borderRadius: 12, border: '1px solid ' + theme.border, padding: '16px 20px', display: 'flex', alignItems: 'center', gap: 16, opacity: 0.6 }}>
                  ...
                  <button onClick={() => toggleActive(s)}
                    style={{ background: '#fee2e2', border: '1px solid #fecaca', borderRadius: 7, padding: '6px 14px', fontSize: 12, fontWeight: 600, cursor: 'pointer', color: '#15803D' }}>
                    Reactivate
                  </button>
                  <button onClick={() => deleteStaff(s)}
                    style={{ background: theme.redBg, border: '1px solid #FECACA', borderRadius: 7, padding: '6px 10px', fontSize: 12, fontWeight: 600, cursor: 'pointer', color: theme.red }}>
